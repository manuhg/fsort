...
set_target_properties(caffe PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "caffeproto;/usr/lib/libboost_system.so;/usr/lib/libboost_thread.so;/usr/lib/libboost_filesystem.so;/usr/lib/libboost_chrono.so;/usr/lib/libboost_date_time.so;/usr/lib/libboost_atomic.so;/usr/local/lib/libglog.so;/usr/lib/libgflags.so;/usr/local/lib/libprotobuf.so;-lpthread;/usr/lib/libhdf5_cpp.so;/usr/lib/libhdf5.so;/usr/lib/librt.so;/usr/lib/libpthread.so;/usr/lib/libz.so;/usr/lib/libdl.so;/usr/lib/libm.so;/usr/lib/libhdf5_hl_cpp.so;/usr/lib/libhdf5_hl.so;/usr/lib/liblmdb.so;/usr/lib/libleveldb.so;opencv_core;opencv_highgui;opencv_imgproc;opencv_imgcodecs;/usr/lib/liblapack.so;/usr/lib/libptcblas.so;/usr/lib/libatlas.so;/usr/lib/libboost_python.so"
